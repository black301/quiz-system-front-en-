    ...
    <div className="space-y-6">
      ...
      <div className="rounded-[10px] bg-white px-7.5 pb-4 pt-7.5 shadow-1 dark:bg-gray-dark dark:shadow-card">
        <div className="mb-6 flex items-center justify-between">
          <h4 className="text-xl font-semibold text-dark dark:text-white">Questions</h4>
          <button
        ...
        {questions.length === 0 ? (
          ...
          <div className="space-y-4">
            {questions.map((question, index) => (
              <div key={question.id} className="rounded-[7px] border border-stroke p-4 dark:border-dark-3">
                <div className="mb-2 flex items-start justify-between">
                  <div className="flex-1">
                    <div className="mb-2 flex items-center gap-2">
                      <span className="text-body-sm font-medium text-primary">Q{index + 1}</span>
                    ...
                    {currentQuestion.options?.map((option, index) => (
                      <div key={index} className="flex items-center gap-3">
                        <input
                          ...
                          onChange={(e) =>
                            setCurrentQuestion((prev) => ({ ...prev, correctAnswer: Number.parseInt(e.target.value) }))
                          }
                  ...
                  <div className="flex gap-4">
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        className="h-4 w-4 text-primary"
                      />
                      <span className="text-body-sm text-dark dark:text-white">True</span>
                    </label>
                    <label className="flex items-center gap-2">
                      <input
                        type="radio"
                        ...
                        className="h-4 w-4 text-primary"
                      />
                      <span className="text-body-sm text-dark dark:text-white">False</span>
                    </label>
                  </div>
                </div>
              )}
